...
> Для приёмки: этот JSON уже в основной ветке. Правило генерации `alias` пока есть только в локальной доработке; в открытую версию [экспортёра №1149](https://github.com/core-ds/ui-primitives/pull/1149) оно ещё не отправлено.
